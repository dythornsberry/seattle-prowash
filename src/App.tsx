...
const BothellLocation = lazy(() => import("./pages/locations/Bothell"));
const LynnwoodLocation = lazy(() => import("./pages/locations/Lynnwood"));
const WoodinvilleLocation = lazy(() => import("./pages/locations/Woodinville"));
const BellevueLocation = lazy(() => import("./pages/locations/Bellevue"));
const EdmondsLocation = lazy(() => import("./pages/locations/Edmonds"));
const MillCreekLocation = lazy(() => import("./pages/locations/MillCreek"));
const MountlakeTerraceLocation = lazy(() => import("./pages/locations/MountlakeTerrace"));
const RedmondLocation = lazy(() => import("./pages/locations/Redmond"));
const SammamishLocation = lazy(() => import("./pages/locations/Sammamish"));
