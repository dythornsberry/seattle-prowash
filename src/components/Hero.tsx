        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left space-y-8 fade-up">
            <div className="space-y-4">
              <Badge variant="outline" className="border-brand-yellow text-brand-navy bg-brand-yellow/10">
                <Star className="w-4 h-4 fill-brand-yellow text-brand-yellow mr-1" />
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-brand-navy leading-tight">
                ...
                <span className="text-brand-yellow block">Cleaning Pros</span>
              </h1>
          ...
          <div className="relative lg:order-last fade-up">
            ...
            <div className="absolute -bottom-6 left-6 right-6 lg:left-0 lg:right-auto lg:w-72">
              <div className="bg-brand-white rounded-xl shadow-xl p-6 border border-brand-yellow/20">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="text-2xl font-bold text-brand-navy">$499+</div>
                    <div className="text-sm text-muted-foreground">Roof Moss Removal</div>
                    <div className="text-xs text-brand-yellow font-semibold">+ FREE Gutter Clean</div>
                  </div>
                  <div className="text-right">
                    <div className="flex text-brand-yellow text-lg">
                      ★★★★★
                    </div>
