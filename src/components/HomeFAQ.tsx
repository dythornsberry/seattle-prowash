...
const topFAQs = [
  ...
  },
  {
    ...
    answer: "Yes. Seattle ProWash is fully licensed, bonded and insured, so your property is protected. We follow all safety protocols and carry complete liability coverage.",
    icon: Shield,
    cta: false
  },
  {
