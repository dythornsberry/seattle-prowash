...
import { navigateToContact as goToContact, navigateToReviews as goToReviews, navigateToHomeTop as goHomeTop } from "@/lib/navigation";
...
const Header = () => {
  ...
  const navigation: NavigationItem[] = [
    { name: "Home", href: "/", onClick: goHomeTop },
