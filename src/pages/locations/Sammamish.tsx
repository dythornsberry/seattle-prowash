                ...
                <div className="grid md:grid-cols-3 gap-8 mb-12">
                  ...
                  <Card className="border-0 shadow-lg">
                    <CardContent className="p-8 text-center">
                      ...
                      <p className="text-gray-600">
                        Over 194 satisfied customers across Sammamish and surrounding areas trust our professional service.
                      </p>
                    </CardContent>
                  </Card>
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-xl text-white/90 mb-8">
                  Join 194+ satisfied customers. Get your free estimate today and see why Sammamish homeowners trust Seattle ProWash.
                </p>
