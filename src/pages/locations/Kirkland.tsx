            ...
            faqs={[
              {
                ...
                answer: "We serve all Kirkland areas including Downtown Kirkland, Juanita, Totem Lake, Houghton, Finn Hill, Kingsgate, and Rose Hill. Fast quotes available throughout Kirkland."
              },
              {
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-xl text-white/90 mb-8">
                  Join 200+ satisfied customers. Experience the Seattle ProWash difference with your fast quote.
                </p>
