              ...
              <div className="max-w-6xl mx-auto">
                <div className="text-center mb-12">
                  ...
                  <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                    Serving Bothell families and businesses with reliable, professional roof and gutter cleaning services for our Pacific Northwest climate.
                  </p>
                </div>
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-primary-teal/10 rounded-lg p-8 mb-8 text-center">
                  ...
                  <p className="text-gray-600 mb-4">Complete exterior cleaning services for all Bothell neighborhoods</p>
                </div>
              ...
              <div className="max-w-4xl mx-auto text-center">
                ...
                <div className="grid md:grid-cols-2 gap-8 text-left">
                  ...
                  <div>
                    ...
                    <p className="text-white/90 mb-6">
                      Our work is backed by complete guarantees, including our exclusive 12-month moss-free promise.
                    </p>
