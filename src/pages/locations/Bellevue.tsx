  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead 
        ...
        description="Expert roof cleaning, gutter cleaning, and moss removal in Bellevue, WA. Serving all Bellevue neighborhoods. 12-month moss-free guarantee. Licensed & insured. Fast quotes."
        url="https://www.seattleprowash.com/bellevue-roof-gutter-cleaning"
      />
      <Header />
                ...
                <div className="grid md:grid-cols-3 gap-8 mb-12">
                  ...
                  <Card className="border-0 shadow-lg">
                    <CardContent className="p-8 text-center">
                      ...
                      <p className="text-gray-600">
                        224 five-star reviews and counting — homeowners across Bellevue and surrounding areas trust our professional service.
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="border-0 shadow-lg">
                    <CardContent className="p-8 text-center">
                      ...
                      <p className="text-gray-600">
                        Fast quotes and quick scheduling for all Bellevue area properties.
                      </p>
                    </CardContent>
                  </Card>
                </div>
          ...
          <ServiceFAQ 
            faqs={[
              ...
              },
              {
                ...
                answer: "We serve all Bellevue areas including Downtown Bellevue, Crossroads, Wilburton, Somerset, Factoria, Bridle Trails, and surrounding neighborhoods. Fast quotes available throughout Bellevue."
              },
              {
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-xl text-white/90 mb-8">
                  Join 224 satisfied customers. Get a fast quote today and see why Bellevue homeowners trust Seattle ProWash.
                </p>
