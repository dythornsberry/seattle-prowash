                ...
                <div className="grid md:grid-cols-3 gap-8 mb-12">
                  ...
                  <Card className="border-0 shadow-lg">
                    <CardContent className="p-8 text-center">
                      ...
                      <p className="text-gray-600">
                        233 five-star reviews and counting — homeowners across Bellevue and surrounding areas trust our professional service.
                      </p>
                    </CardContent>
                  </Card>
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-xl text-white/90 mb-8">
                  Join 233 satisfied customers. Get a fast quote today and see why Bellevue homeowners trust Seattle ProWash.
                </p>
