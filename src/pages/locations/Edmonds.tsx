...
const Edmonds = () => {
  ...
  const localFAQs = [
    ...
    },
    {
      ...
      answer: "We service Edmonds year-round. Submit the quote form and Dylan will call or text to confirm details and help you get clear pricing. If you want to move forward, we'll work with you to find a service time that fits."
    }
  ];
  ...
  return (
    <>
      <SEOHead 
        ...
        description="Professional roof cleaning, moss removal & gutter cleaning in Edmonds. Expert exterior cleaning services with 5-star reviews. Fast quotes. Call (206) 752-6690"
        url="https://www.seattleprowash.com/edmonds-roof-gutter-cleaning"
      />
          ...
          <section className="py-16 bg-brand-navy text-white">
            <div className="container mx-auto px-4 text-center">
              ...
              <p className="text-xl mb-8 max-w-2xl mx-auto">
                Get a fast, no-pressure quote for professional exterior cleaning services in Edmonds.
              </p>
