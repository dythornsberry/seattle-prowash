...
const Kenmore = () => {
  useEffect(() => {
    document.title = "Roof & Gutter Cleaning in Kenmore, WA | Seattle ProWash";
    
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute(
        "content", 
        "Expert roof & gutter cleaning in Kenmore, WA. Serving Kenmore Highlands, Moorlands, Inglewood. 12-month moss-free guarantee. Licensed & insured. Same-day quotes."
      );
    }

    // Add geographic meta tags for Kenmore
    ...
    addOrUpdateMetaTag('geo.placename', 'Kenmore');
