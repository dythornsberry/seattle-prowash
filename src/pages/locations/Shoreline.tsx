  ...
  return (
    <>
      <SEOHead 
        ...
        description="Professional roof cleaning, moss removal & gutter cleaning in Shoreline. Expert roof and gutter services with 5-star reviews. Fast quotes. Call (206) 752-6690"
        url="https://www.seattleprowash.com/shoreline-roof-gutter-cleaning"
      />
          ...
          <section className="py-16 bg-brand-navy text-white">
            <div className="container mx-auto px-4 text-center">
              ...
              <p className="text-xl mb-8 max-w-2xl mx-auto">
                Get a fast, no-pressure quote for professional roof and gutter cleaning services in Shoreline.
              </p>
