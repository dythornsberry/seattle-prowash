            ...
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-xl md:text-2xl text-white/90 leading-relaxed mb-8">
                  Based in Kenmore, we provide professional roof and gutter cleaning services to homeowners within ~15 miles across the Seattle metro area — including Seattle, Bellevue, Redmond, Sammamish, Woodinville, Kirkland, Bothell, Shoreline, Mukilteo, Mill Creek, Lynnwood and other nearby communities.
                </p>
